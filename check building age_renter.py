...
#%% Those are the building rented by people -  renters
...
pd.concat(age).to_csv('Analysis/building_age_by_race_income__renters.csv')
...
plt.show()
plt.savefig('building_age_by_race_income__renters.png',dpi=300)
...
pd.concat(age).to_csv('Analysis/building_age_by_race_wealth__renters.csv')
...
plt.legend(bbox_to_anchor=(1,1), loc="upper left",prop={'size': 15})
plt.show()
plt.savefig('building_age_by_race_wealth__renters.png',dpi=300)
...
#%% Plot  - all states - By income  and  wealth -- renters only
...
df_income=pd.read_stata('Analysis/building_age_by_race_income_all_states__renter.dta')
df_wealth=pd.read_stata('Analysis/building_age_by_race_wealth_all_states__renter.dta')
...
plt.show()
plt.savefig('building_age_by_race_all_states__renters.png',dpi=300)
